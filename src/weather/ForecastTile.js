...
class ForecastTile extends React.Component {
  ...
  changeRenderedData = () => {
    if(this.state.dataToRender.time === 'day') {
      this.setState({
        dataToRender: {
          temp: this.props.nightWeather.main.temp,
          pressure: this.props.nightWeather.main.pressure,
          wind: this.props.nightWeather.wind.speed,
          time: "night",
          date: this.parseDate(this.props.dayWeather.dt_txt)
        }
      });
    } else {
      this.setState({
        dataToRender: {
          temp: this.props.dayWeather.main.temp,
          pressure: this.props.dayWeather.main.pressure,
          wind: this.props.dayWeather.wind.speed,
          time: "day",
          date: this.parseDate(this.props.dayWeather.dt_txt)
        }
      })
